...
namespace T2IN1_REBORN_LIB.Helpers
{
    public static class Entities
    {
        ...
        public static IEnumerable<Obj_AI_Base> CachedEnemies = GetEnemies;
        public static IEnumerable<Obj_AI_Base> CachedAllies = GetEnemies;
        ...
        public static IEnumerable<Obj_AI_Base> GetEnemysInRange(float range) => CachedEnemies.Where(x => x.IsValidTarget(range));
        ...
        public static Obj_AI_Base GetNearestAlly(float range = 700) => CachedAllies.OrderBy(a => a.Distance(ObjectManager.Me)).FirstOrDefault(ally => ally.IsInRange(ObjectManager.Me, range));
        public static Obj_AI_Base GetNearestLowestAlly(float range = 700) => CachedAllies.OrderBy(a => a.Distance(ObjectManager.Me)).ThenBy(a => a.Health).FirstOrDefault(ally => ally.IsInRange(ObjectManager.Me, range));
    }
}
